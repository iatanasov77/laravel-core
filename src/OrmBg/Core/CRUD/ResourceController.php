...
use OrmBg\Core\Model\Interfaces\MetadataAwareInterface;
use OrmBg\Core\Model\Interfaces\TaxonomyAwareInterface;
use OrmBg\Core\Model\Interfaces\TranslateAwareInterface;
use OrmBg\Core\Model\Interfaces\SortAwareInterface;
use OrmBg\Core\Model\Interfaces\ActivatableAwareInterface;
use OrmBg\Core\Service\Status;
use OrmBg\Core\CRUD\Exception\ResourceControllerException;
...
class ResourceController extends Controller
{
    ...
    protected function initResource()
    {
        ...
        $configPrefix   = $classSegments[0] === 'OrmBg' ? 'ormbg.' : '';
